...
Valor de retorno
La cadena de caracteres que resulte de las aplicaciones sucesivas de ’f’.
...
Descripción
Aplica la función ’f’ a cada carácter de la de cadena de caracteres ’s’ para crear una nueva cadena de caracteres
